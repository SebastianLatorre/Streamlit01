...
st.set_page_config(page_title="App de predicción",
                   page_icon="https://d29fhpw069ctt2.cloudfront.net/icon/image/84584/preview.svg",
                   layout="centered",
                   initial_sidebar_state="auto")

# Definimos el titulo y la descripcion de la aplicacion
st.title("Aplicación de Predicción de Enfermedades Cardiacas")
st.markdown("""Esta aplicación predice si tienes una enfermedad cardiaca basandose en los datos ingresados""")
st.markdown("""---""")
